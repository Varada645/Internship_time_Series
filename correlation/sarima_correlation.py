...
# Load SARIMA forecast data
giardiasis = pd.read_csv(f"{base_dir}/Giardiasis_sarima_forecast_extended.csv", usecols=["Date", "Forecast"], parse_dates=["Date"])
chickenpox = pd.read_csv(f"{base_dir}/chickenpox_sarima_forecast_extended.csv", usecols=["Date", "Forecast"], parse_dates=["Date"])
...
plt.plot(df.index, df['Giardiasis'], label='Giardiasis SARIMA Forecast', alpha=0.7)
plt.plot(df.index, df['Chickenpox'], label='Chickenpox SARIMA Forecast', alpha=0.7)
...
# Print results
print("\nSARIMA Forecast Correlation Results:")
print(results_df)
print(f"\nSaved results to: {output_dir}/sarima_forecast_correlation_results.csv")
print(f"Saved plots to: {output_dir}/sarima_forecast_time_series.png, sarima_forecast_correlation_heatmap.png, sarima_forecast_cross_correlation_max.png")